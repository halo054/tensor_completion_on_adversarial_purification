...
def load_data(args, adv_batch_size,ngpus):
    if 'imagenet' in args.domain:
        ...
        val_loader = DataLoader(val_data, batch_size=n_samples, shuffle=False, pin_memory=True, num_workers = ngpus)
        ...
        loader = DataLoader(clean_dset, batch_size=adv_batch_size, shuffle=False,
                            pin_memory=True, num_workers=ngpus)
